...
export default function CaisseCentrale() {
  ...
  const [menuCategories] = useState([
    {
      ...
      items: [
        { id: 'cafe1', name: 'Café Expresso', price: 2.50, category: 'Chaud' },
        { id: 'cafe2', name: 'Café Crème', price: 3.00, category: 'Chaud' },
        { id: 'the1', name: 'Thé Nature', price: 2.50, category: 'Chaud' },
        { id: 'choco1', name: 'Chocolat Chaud', price: 3.50, category: 'Chaud' },
      ]
    },
    {
      ...
      items: [
        { id: 'coca1', name: 'Coca-Cola', price: 3.00, category: 'Froid' },
        { id: 'eau1', name: 'Eau Minérale', price: 2.00, category: 'Froid' },
        { id: 'jus1', name: 'Jus d\'Orange', price: 4.00, category: 'Froid' },
        { id: 'smoothie1', name: 'Smoothie', price: 5.50, category: 'Froid' },
      ]
    },
    {
      name: 'Vins & Alcools',
      ...
      items: [
        { id: 'vin1', name: 'Vin Rouge (verre)', price: 6.00, category: 'Alcool' },
        { id: 'vin2', name: 'Vin Blanc (verre)', price: 6.00, category: 'Alcool' },
        { id: 'biere1', name: 'Bière Pression', price: 4.50, category: 'Alcool' },
        { id: 'cocktail1', name: 'Cocktail Maison', price: 8.00, category: 'Alcool' },
      ]
    }
  ])
  ...
  const [recentOrders] = useState<Order[]>([
    {
      ...
      orderNumber: 'BAR-001',
      items: [
        { id: '1', name: 'Café Expresso', price: 2.50, quantity: 2, category: 'Chaud' },
        { id: '2', name: 'Croissant', price: 2.00, quantity: 1, category: 'Pâtisserie' }
      ],
      total: 7.00,
      status: 'COMPLETED',
    ...
    },
    {
      ...
      orderNumber: 'BAR-002',
      items: [
        { id: '3', name: 'Vin Rouge (verre)', price: 6.00, quantity: 1, category: 'Alcool' },
        { id: '4', name: 'Assiette Fromage', price: 8.50, quantity: 1, category: 'Plat' }
      ],
      total: 14.50,
      status: 'PENDING',
      tableNumber: 'T6',
  ...
  const processPayment = (method: string) => {
    ...
    const hasFoodItems = cart.some(item => item.category !== 'Alcool' && item.category !== 'Froid' && item.category !== 'Chaud')
    if (hasFoodItems) {
    ...
    setTodayStats(prev => ({
      ...
      [method === 'CASH' ? 'cashSales' : 'cardSales']: prev[method === 'CASH' ? 'cashSales' : 'cardSales'] + order.total
    }))
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Gestion des ventes et encaissements</p>
              </div>
            </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">€{todayStats.cashSales.toFixed(2)}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">€{todayStats.cardSales.toFixed(2)}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">€{todayStats.averageOrder.toFixed(2)}</p>
                </div>
              ...
              <TabsContent value="commandes" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Commandes des tables en attente de paiement</CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        <div key={order.id} className="border rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            <div>
                              ...
                              <span className="ml-2 text-sm text-gray-600">{order.tableNumber} • {order.customerName}</span>
                            </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <Badge variant={order.paymentMethod === 'CASH' ? 'default' : 'secondary'}>
                                {order.paymentMethod === 'CASH' ? <Banknote className="h-3 w-3 mr-1" /> : <CreditCard className="h-3 w-3 mr-1" />}
                                {order.paymentMethod}
                              </Badge>
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((notification) => (
                      <div key={notification.id} className={`p-2 rounded text-sm ${notification.read ? 'bg-gray-50' : 'bg-blue-50'}`}>
                        <div className="flex items-center gap-2">
                          {notification.type === 'NEW_ORDER' && <AlertCircle className="h-4 w-4 text-blue-600" />}
                          {notification.type === 'ORDER_READY' && <CheckCircle className="h-4 w-4 text-green-600" />}
